...
<img align='right' height='210' src='https://raw.githubusercontent.com/devicons/devicon/master/icons/python/python-original.svg' alt='Data Engineering'>

<ul style="list-style-type: none; padding: 0;">
  <li style="margin-bottom: 10px;">
    📊 <strong>Analista & Engenheira de Dados</strong>
  </li>
  <li style="margin-bottom: 10px;">
    ⚙️ Atuação com <strong>pipelines, APIs e dados em tempo real</strong>
  </li>
  <li style="margin-bottom: 10px;">
    🧠 Experiência em <strong>análise, NLP e identificação de padrões</strong>
  </li>
  <li style="margin-bottom: 10px;">
    🚀 Dados aplicados a <strong>mobilidade, segurança e sistemas inteligentes</strong>
  </li>
</ul>
